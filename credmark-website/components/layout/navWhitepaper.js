...
export default function NavWhitepaper(props) {
        ...
        <div>
            <div className="flex h-screen overflow-hidden max-w-7xl block m-auto">
                ...
                <div className="flex flex-col w-0 flex-1 overflow-hidden md:mr-40">
                    ...
                    <main className="flex-1 mb-2.5 relative overflow-y-auto focus:outline-none rounded-4xl bg-transparent 2xl:bg-white">
                        <div>
                            {props.page}
                        </div>
                    </main>
