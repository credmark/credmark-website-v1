...
const CCRCard = (props) => {
    return (
        <>
        <div className="cusor-pointer border-2 border-credmarkpurple rounded-lg text-center mb-10 py-10 md:mx-10 md:pt-10 drop-shadow-xl transform hover:scale-105">
