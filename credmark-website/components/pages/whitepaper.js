        ...
        <>
            <main className="flex-1 relative overflow-y-auto focus:outline-none rounded-md ">
                    <div className="rounded-md">
                        <div className="px-5 py-10 md:pt-28 md:px-40 homeTop">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 block m-auto homeBottom">
                        ...
                        <a href="https://reports.credmark.com/whitepaper.pdf" target="_blank" rel="noreferrer"><img width={350} className="block m-auto" src="/assets/credmark-tc-white-paper.png" alt="Credmark White Paper"></img></a>
