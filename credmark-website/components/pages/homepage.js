        ...
        <>
            <div>
                ...
                <div className="swirls">
                    <Image src="/assets/swirls-transparent.png" alt="colored swirls" />
                </div>
            </div>
            <div>
            </div>
                ...
                <div className="max-w-7xl block m-auto">
                    <div className="px-5">
                        ...
                        <div className="max-w-4xl block m-auto pb-16">
                            <Image alt="What is Credmark graph" className="hidden md:flex block m-auto" src="/assets/what-is-credmark.png" />
                            <Image alt="What is Credmark graph" className="flex md:hidden block m-auto" src="/assets/what-is-credmark-mobile.png" />
                        </div>
                    </div>
                </div>
            </div>
            <div className="max-w-7xl block m-auto">
                <div className="px-5">
                    ...
                    <div className="max-w-4xl block m-auto pb-16">
                        <Image alt="Discord channel link" className="hidden md:flex block m-auto" src="/assets/how-credmark-works.png" />
                        <Image alt="Discord channel link" className="flex md:hidden block m-auto" src="/assets/how-credmark-works-mobile.png" />
                    </div>
                </div>
            </div>
            <div className="max-w-7xl block m-auto">
            ...
            <div className="riskEncyclopedia">
                <div className="grid grid-cols-1 md:grid-cols-2 py-10 px-5 md:px-20 block m-auto max-w-7xl">
                    ...
                    <div>
                        <a href="https://docs.credmark.com/credmark-risk-library/" target="_blank" rel="noreferrer"><Image alt="Credmark Risk Library" className="md:max-h-80 block m-auto" src="/assets/encyclopedia.png" /></a>
                    </div>
                </div>
            </div>
                    ...
                    <div className="text-center">
                        ...
                        <div className="flex justify-center pt-10">
                            <Link href="/reports" passHref>
                                <p className="credmark cursor-pointer text-center text-md float-left">All reports<Image width={40} className="float-right pt-0 pl-5" alt="arrow right" src="../assets/Arrow-1.svg" /></p>
                            </Link>
                        </div>
                        <div>
                        </div>
            ...
            <div>
                <div className="riskEncyclopedia">
                    <div className="grid grid-cols-1 md:grid-cols-2 py-10 px-5 md:px-20 block m-auto max-w-7xl mt-10 lg:my-28">
                        <div className="order-2 md:order-1">
                            <a href="https://app.credmark.com/" target="_blank" rel="noreferrer"><Image alt="Credmark App" className="app-image block m-auto md:pr-16" src="/assets/credmark-app.jpg" /></a>
                        </div>
                ...
                <div className="max-w-4xl block m-auto">
                    <div className="grid grid-cols-1 m-auto block md:grid-cols-3 px-5 pb-10 md:pb-20">
                        <Image className="py-5" width={150} src="../assets/dlab-logo.svg" alt="DLAB logo" />
                        <Image className="py-5" width={150} src="../assets/longhash-logo.svg" alt="Long Hash Ventures logo" />
                        <Image className="py-5" width={150} src="../assets/api3-logo.svg" alt="API3 logo" />
                        <Image className="py-5" width={200} src="../assets/steady-state-logo.svg" alt="Solidity Ventures logo" />
                        <Image className="py-5" width={150} src="../assets/Coinshift.svg" alt="Coinshift logo" />
                        <Image className="py-5" width={150} src="../assets/yieldapp-logo.svg" alt="Spark Digital Capital logo" />
                    </div>
                </div>
            </div>
            <Subscribe />
