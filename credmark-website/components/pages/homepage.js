            ...
            <div className="staking py-24 lg:py-48">
                <div className="grid grid-cols-1 md:grid-cols-2 px-5 md:px-20 block m-auto max-w-6xl">
                    ...
                    <div className="pl-5 md:pl-10 order-1 lg:order-2">
                        ...
                        <a href="https://docs.sushi.com/how-to-get-started-on-sushi/how-to-swap#:~:text=Step%201%3A%20Head%20to%20sushi,you%20wish%20to%20swap%20to." target="blank" rel="noreferrer"><p className="text-center md:text-left text-sm float-left pt-5">How to stake $CMK<img width={40} className="float-right pt-0.5 pl-4" alt="arrow right" src="../assets/arrow-right-2.svg" /></p></a>
                    </div>
                </div>
            </div>
