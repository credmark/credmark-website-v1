...
async function getAllPosts() {
  const results = await _sanity__WEBPACK_IMPORTED_MODULE_0__/* .default.fetch */ .Z.fetch(`*[_type == "post"]| order(publishedAt desc) {${postFields}}`);
  return results;
}
...
/* harmony export */ });
/* harmony import */ var _sanity_client__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(9729);
